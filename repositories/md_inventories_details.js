...
const getMdInventories = async (bd_name, host, page, invoice_date, begin_date, end_date) => {//Funcion de tipo asincronica.
    ...
    const inventories = await queryMdInventories(page, mysql, limit, offset, filter_invoice_date, filter_between)
    let jsonResult = {
