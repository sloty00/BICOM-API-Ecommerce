...
const getMdBimarketDetail = async (bd_name, host, page, invoice_date, begin_date, end_date) => {//Funcion de tipo asincronica.
    ...
    switch (invoice_date !=="" && invoice_date) {
        ...
        case invoice_date:
            filter_invoice_date="WHERE t_bimarkets.invoice_date = " + `'${invoice_date}'`;
            console.log('Quotes');
        break;
    }
    switch (filter_invoice_date !== "" && begin_date !=="" && begin_date) {
        ...
        case begin_date:
            filter_begin_date="WHERE t_bimarkets.invoice_date >= " + `'${begin_date}'`;
            console.log('Quotes');
        break;
    }
    ...
    const bimarketsdet = await queryMdBimarketDetail(page, mysql, filter_invoice_date, filter_between)
    let jsonResult = {
