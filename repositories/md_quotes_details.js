...
const getMdQuoteDetail = async (bd_name, host, page, invoice_date, begin_date, end_date) => {//Funcion de tipo asincronica.
    ...
    switch (invoice_date !=="" && invoice_date) {
        ...
        case invoice_date:
            filter_quote_date="WHERE quotes.quote_date = " + `'${invoice_date}'`;
            console.log('Quotes');
        break;
    }
    switch (filter_quote_date !== "" && begin_date !=="" && begin_date) {

        case begin_date:
            filter_begin_date="WHERE quotes.quote_date >= " + `'${begin_date}'`;
            console.log('Quotes');
        break;
    }
    switch (filter_quote_date !== "" && end_date !=="" && end_date) {
    ...
    const quotesdet = await queryMdQuoteDetail(page, mysql, filter_quote_date, filter_between)
